...
$thumbs_pr_page 		= "66"; //Number of thumbnails on a single page
$gallery_width 			= "1366px"; //Gallery width. Eg: "500px" or "70%"
$backgroundcolor 		= "#39C3DB"; //This provides a quick way to change your gallerys background to suit your website. Use either main colors like "black", "white", "yellow" etc. Or HEX colors, eg. "#AAAAAA"
$templatefile 			= "exhibition"; //Template filename (must be placed in 'templates' folder)
$title 				= "Tiszta Miskolc"; // Text to be displayed in browser titlebar
$author 			= "Miskolc Holding Zrt.";
...
$label_page 			= "Lapok: "; //Text used for page navigation
$label_all 			= "Mind"; //Text used for link to display all images in one page
